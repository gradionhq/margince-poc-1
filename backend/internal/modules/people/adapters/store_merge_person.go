// Package adapters — PersonStore.Merge (PO-AC-17, PO-AC-M1 through PO-AC-M5).
package adapters
...
func (s *PersonStore) Merge(ctx context.Context, loserID, targetID, workspaceID string) (domain.Person, error) {
	if loserID == targetID {
