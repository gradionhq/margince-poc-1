...
func TestOrgCreate_FuzzyReview_LegalSuffixNormalizedEqual(t *testing.T) {
	...
	existing := crmcore.NewOrganization("Acme GmbH", prov.Provenance{Source: "api", CapturedBy: "human:test"})
	...
	candidate := crmcore.NewOrganization("Acme Inc", prov.Provenance{Source: "api", CapturedBy: "human:test"})
...
func TestOrgCreate_NoReviewFlag_UnrelatedName(t *testing.T) {
	...
	unrelated := crmcore.NewOrganization("Zephyr Robotics", prov.Provenance{Source: "api", CapturedBy: "human:test"})
