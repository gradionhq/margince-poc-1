...
func openHandlerDealPartnerTestDB(t *testing.T) *sql.DB {
	t.Helper()
...
func seedHandlerDealPartnerFixtures(t *testing.T, db *sql.DB, tag string) (pipelineID, stageID, orgAID, orgBID string) {
	t.Helper()
