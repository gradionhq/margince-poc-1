...
func scanPartnerRow(row partnerRowScanner) (Partner, error) {
	var p Partner
...
func (s *PartnerStore) Upsert(ctx context.Context, p Partner) (Partner, error) {
...
func (s *PartnerStore) Get(ctx context.Context, organizationID, workspaceID string) (Partner, error) {
	var p Partner
...
func (s *PartnerStore) List(ctx context.Context, workspaceID, cursor string, limit int, filter PartnerListFilter) ([]Partner, string, error) {
