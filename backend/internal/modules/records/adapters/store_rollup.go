...
// rowScopeAll is the row_scope value meaning "no ownership restriction"
// (RD-T04 Architecture-section readability table / RecordVisible's own
// row_scope check in record_visibility.go).
const rowScopeAll = "all"
