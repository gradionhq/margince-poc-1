...
// The live-schema assertion (B-E02.9 AC-1/AC-5) lives in crosscutting/schema_guard_test.go
// behind the `integration` build tag and feeds the real introspected rows into the same checker.
